...
function mostrarDatosPerfil(data) {
  ...
  document.getElementById("apellido_paternoEdit").value =
    data.apellido_paterno || "";
  document.getElementById("apellido_maternoEdit").value =
    data.apellido_materno || "";
  document.getElementById("telefonoEdit").value = data.telefono || "";
  document.getElementById("carreraEdit").value = data.carrera || "";

   // Verificar si hay una imagen cargada en la base de datos
    if (data.img_perfil) {
        // Usar la ruta desde la base de datos
        document.getElementById('fotoPerfilActual').src = `img/perfiles/${data.img_perfil}`;
    } else {
        // Si no hay imagen, mostrar la imagen por defecto
        document.getElementById('fotoPerfilActual').src = "img/perfiles/ejemploperfil.ico";
    }
