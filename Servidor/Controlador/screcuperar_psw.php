...
<head>
    ...
    <title>Recuperación de contraseña para Super Administrador</title>
...
<body>
    <div class="wrapper">
        <div class="recup">
            ...
            <form action="#" method="POST">
                <h1>Recupera tu contraseña de Super Administrador</h1>
                <div class="input-box">
                ...
                <p>Volver a <a href="../Vista/sadmin-login.html">Iniciar sesión</a></p>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="window.location.href='../Vista/sadmin-login.html';">REGRESAR A INICIO DE SESIÓN</button>
                </div>
            </div>
        </div>
    </div>
    ...
    if (isset($_POST["recuperar"])) {
        ...
        $mail->isHTML(true);
        $mail->Subject = "Recupera tu contraseña de Super Administrador";
        $mail->Body = '
        <!DOCTYPE html>
        <html lang="es">
        <head>
          ...
          <style>
            ...
            <div class="container">
                ...
                <a href="http://localhost/AppAlertaMedica/Servidor/Controlador/screstablecer_psw.php?token='. $token. '" class="button" style="color: #fff; text-decoration: none; font-size: 16px; font-weight: bold;">Restablecer Contraseña</a>
